...
# Define the IDs of the specific block volumes you want to work with
specific_volume_ids = ['volume_id_1', 'volume_id_2', 'volume_id_3']  # Replace with your specific volume IDs

# Create an empty list to store volumes that will be used in the process
selected_volumes = []

# Retrieve specific block volumes' details
for volume_id in specific_volume_ids:
    volume_details = block_storage_client.get_volume(volume_id).data
    selected_volumes.append(volume_details)
...
# Create block volume images from the selected volumes and then create volumes from those images
new_volumes = []
